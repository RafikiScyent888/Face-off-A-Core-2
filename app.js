...
FirebaseTransport.prototype = {
  ...
  _basePath: function () { return 'rooms/' + this.room; },
...
/* The deck remembers which clues have been used. It outlives a single
   ...
   editing questions-core2.js starts the memory over instead of pointing
...
function Launcher() {
  ...
  '<div class="launch"><div class="launch-inner">' +
    ...
    '<h1>FACE-OFF</h1>' +
    '<div class="sub">A+ Core 2 &nbsp;·&nbsp; 220-1202 &nbsp;·&nbsp; Team Review</div>' +
...
function Host(forcedCode) {
  ...
  function topbar() {
    return '<div class="topbar">' +
      ...
      '<div class="t2">A+ CORE 2 · 220-1202</div></div></div>' +
      ...
      (function () {
        ...
        return '<div style="margin-top:16px"><label class="fld">What are we playing?</label>' +
          ...
          (have ? '' : '<div class="hint" style="margin-top:6px">' +
            'Add <span class="mono">acronyms-core2.js</span> to enable the other two styles.</div>') +
        '</div>';
      })() +
